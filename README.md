...
<p>Currently specializing in  C# and many Microsoft technologies, i.e. .NET, WPF, Entity Framework, ADO.NET, ASP.NET, MySQL Server, Azure DevOps (see my latest repos if you want to know more !)</p>
